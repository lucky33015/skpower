                    ...
                    <div slot="left" class="demo-split-pane">
                        <template>
                            <i-form ref="formValidate" :model="formValidate" :rules="ruleValidate"  label-position="top" >
                                <form-item label="图文标题:" prop="title">
                                    <i-input v-model="formValidate.title" placeholder="请输入要发送的图文标题"
                                             />
                                </form-item>

                                <form-item label="图文跳转链接:" prop="url">
                                    <i-input v-model="formValidate.url" placeholder="请输入图文跳转链接"
                                             />
                                </form-item>

                                <form-item label="图文封面图链接:" prop="picurl">
                                    <i-input v-model="formValidate.picurl" placeholder="请输入图文封面图链接,支持oss远程url链接"
                                             />
                                </form-item>
