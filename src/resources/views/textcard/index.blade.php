                    ...
                    <div slot="left" class="demo-split-pane">
                        <template>
                            <i-form ref="formValidate" :model="formValidate" :rules="ruleValidate"  label-position="top" >
                                <form-item label="卡片标题:" prop="title">
                                    <i-input v-model="formValidate.title" placeholder="请输入要发送的卡片标题"
                                             />
                                </form-item>

                                <form-item label="卡片描述:" prop="description">
                                    <i-input v-model="formValidate.description" placeholder="请输入卡片描述"
                                    />
                                </form-item>

                                <form-item label="卡片跳转链接:" prop="url">
                                    <i-input v-model="formValidate.url" placeholder="请输入卡片跳转链接"
                                             />
                                </form-item>
    ...
    <script>
        new Vue({
            ...
            data: {
                ...
                ruleValidate: {
                    title: [
                        {required: true, message: '请填写发送卡片标题!', trigger: 'blur'}
                    ],
                    description: [
            ...
            methods: {
                handleSubmit(name) {
                    this.$refs[name].validate((valid) => {
                        if (valid) {
                            var url = "{{url('skpower/text_card/send')}}";
                            this.$Loading.start();
                            this.$http.post(url, {
