...
class VoiceController extends BaseController
{
    public function index(){
        $msg = 'this is voice';
        $code = $this->codeText();
        return view('skpower::voice.index',['msg'=>$msg,'title' => '语音消息', 'code' => $code]);
    }

    public function send(Request $request){
        try{
            $message = $request->post('voice');
            if (empty($message)) {
            ...
            //发送
            app(BdyNotice::class)->sendNotice('voice',$message,$userIds);
    ...
    public function codeText(){
        ...
        $str .=  '<span class="bianliang">$path</span> = <span class="param">"D://voice/test.amr"</span> //此处也支持网络图片路径(http://oss.com/test.amr)' . "\n";
        $str .= '       ' . "\n";
        $str .=  '//<span class="zhushi">获取接口返回的media_id</span>' . "\n";
        $str .=  '<span class="bianliang">$mediaId</span> = app(BdyNotice::class)->uploadMedia(<span class="param">"voice"</span>,$path);' . "\n";
        $str .= '       ' . "\n";
        ...
        $str .= '<span class="bianliang">$message</span> = <span class="bianliang">$request</span>->post("voice");' . "\n";
        $str .= '       ' . "\n";
        ...
        $str .= 'app(BdyNotice::class)->sendNotice(<span class="param">"voice</span>",<span class="bianliang">$message</span>,<span class="bianliang">$userIds</span>);' . "\n";
        return $str;
    }
